     ...
     const int MAX_READS, const Bool SINGLE )
{
     ...
     // NOTE EXPENSIVE CONVERSION !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     MakeClosures( HyperBasevectorX(hbl), 
          invl, pathsl, paths_indexl, dupl, badl, all_closuresl, False );
     #pragma omp critical
     {    c6a1 += WallClockTime( );
          c6a2 -= WallClockTime( );    }
     ...
     // NOTE EXPENSIVE CONVERSION!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ClosuresToGraph( HyperBasevectorX(hbl), invl, all_closuresl, Dl, dinvl, False );
     #pragma omp critical
     {    c6a2 += WallClockTime( );
          c6a3 -= WallClockTime( );    }
     // NOTE EXPENSIVE CONVERSION!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     Cleaner( HyperBasevectorX(hbl), invl, pathsl, dupl, Dl, dinvl, dpathsl, False );
     if (verbose)
     ...
     {    c6a3 += WallClockTime( );
          c6b -= WallClockTime( );    }
     // NOTE EXPENSIVE CONVERSION!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     PlaceReads( HyperBasevectorX(hbl), pathsl, dupl, Dl, dpathsl, False, SINGLE );
