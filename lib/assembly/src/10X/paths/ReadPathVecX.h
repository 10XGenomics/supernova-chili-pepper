...
public:
    ...
    ReadPathVecX(const ReadPathVec& paths, const HyperBasevectorX& hb);

    ReadPathVecX(const ReadPathVec& paths, const HyperBasevectorX& hb, const int64_t sid, const int64_t numReads);

    ReadPathVecX(const VReadPathVec& paths, const HyperBasevectorX& hb);

    ReadPathVecX(const VReadPathVec& paths, const HyperBasevectorX& hb, const int64_t sid, const int64_t numReads);
